...
public class CustomMissionView extends MissionManagerBaseView {
    ...
    protected DJIMission initMission() {
        ...
        steps.add(new DJIGimbalAttitudeStep(
                ...
                null,
                new DJIGimbal.DJIGimbalAngleRotation(true, -30f, DJIGimbal.DJIGimbalRotateDirection.CounterClockwise),
        ...
        DJIGoToStep testGoToStep = new DJIGoToStep(mHomeLatitude, mHomeLongitude, 10, new DJIBaseComponent.DJICompletionCallback() {
            @Override
            public void onResult(DJIError error) {
                Utils.setResultToToast(mContext, "Goto step: " + (error == null ? "Success" : error.getDescription()));
            }
        });
        testGoToStep.setFlightSpeed(0.5f);
        steps.add(testGoToStep);
/*
